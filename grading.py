...
""" % (prereq, q, q, prereq))
      ...
      try:
        ...
        timeout.TimeoutFunction(getattr(gradingModule, q), self.timeOuts[q])(self) 
        ...
        # In Linux it will work because timeout will stop right away, but in Windows it may have completed and got all points even with timeout!
        self.points[q] = 0
